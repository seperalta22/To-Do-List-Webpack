...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _img_refresh_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./img/refresh.svg */ \"./src/img/refresh.svg\");\n/* harmony import */ var _setTasks_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./setTasks.js */ \"./src/setTasks.js\");\n\r\n\r\n\r\n\r\nconst titleContainer = document.querySelector('.title-container');\r\nconst refreshIcon = document.createElement('img');\r\nrefreshIcon.src = _img_refresh_svg__WEBPACK_IMPORTED_MODULE_1__;\r\nrefreshIcon.classList.add('refresh-icon');\r\ntitleContainer.appendChild(refreshIcon);\r\n\r\nconst tasksList = document.querySelector('.list');\r\n\r\nconst renderTasks = () => {\r\n\ttasksList.innerHTML = '';\r\n\t_setTasks_js__WEBPACK_IMPORTED_MODULE_2__.tasks.forEach((task) => {\r\n\t\t(0,_setTasks_js__WEBPACK_IMPORTED_MODULE_2__.createTask)(task);\r\n\t});\r\n};\r\n\r\nrenderTasks();\r\n\r\nconst input = document.querySelector('.input');\r\n\r\ninput.addEventListener('keydown', (e) => {\r\n\tif (e.key === 'Enter' && input.value !== '') {\r\n\t\t(0,_setTasks_js__WEBPACK_IMPORTED_MODULE_2__.addTask)(input.value);\r\n\t\trenderTasks();\r\n\t\tinput.value = '';\r\n\t}\r\n});\r\n\r\nconst taskItem = document.querySelector('.list-item');\r\n\r\ntaskItem.addEventListener('click', (e) => {\r\n\tif (e.target.classList.contains('checkbox')) {\r\n\t\t(0,_setTasks_js__WEBPACK_IMPORTED_MODULE_2__.toggleTask)(e.target.id);\r\n\t\trenderTasks();\r\n\t}\r\n\tif (e.target.classList.contains('dots-icon')) {\r\n\t\tconst task = e.target.closest('.list-item');\r\n\t\tconst taskId = task.dataset.key;\r\n\t\tconst taskLabel = task.querySelector('.task-label');\r\n\t\tconst taskInput = document.createElement('input');\r\n\t\ttaskInput.classList.add('task-input');\r\n\t\ttaskInput.value = taskLabel.textContent;\r\n\t\ttaskLabel.replaceWith(taskInput);\r\n\t\ttaskInput.focus();\r\n\t\ttaskInput.addEventListener('keydown', (e) => {\r\n\t\t\tif (e.key === 'Enter' && taskInput.value !== '') {\r\n\t\t\t\t(0,_setTasks_js__WEBPACK_IMPORTED_MODULE_2__.editTask)(taskId, taskInput.value);\r\n\t\t\t\trenderTasks();\r\n\t\t\t}\r\n\t\t});\r\n\t}\r\n});\r\n\n\n//# sourceURL=webpack://todo-list/./src/index.js?");
